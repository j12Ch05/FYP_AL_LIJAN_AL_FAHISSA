...
if (mysqli_stmt_affected_rows($stmt) > 0) {
    $_SESSION['admin_status_message'] = 'Professor has been made an admin successfully.';
} else {
    $_SESSION['admin_status_message'] = 'Error: Professor not found or already an admin.';
}
